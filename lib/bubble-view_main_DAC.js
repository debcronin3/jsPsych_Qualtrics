...
function generate_practice_block(
  ...
  for (var ii = 0; ii < num_trial; ii++) {
    ...
    var bubble_phase = {
      ...
      blur_image: prac_img_src + prac_seq[ii] + "_1blur." + img_ext,
...
function generate_main_block(main_img_src, main_seq, img_ext, img_attn = []) {
  ...
  for (var ii = 0; ii < num_trial; ii++) {
    ...
    var bubble_phase = {
      ...
      blur_image: main_img_src + main_seq[ii] + "_1blur." + img_ext,
...
function generate_test_block(test_img_src, test_seq, img_ext) {
  ...
  var test_instructions_page = {
    ...
    pages: [
      ...
      In this part of the study, you will see a series of images. Some of the images are new and some are the same \
      images you saw earlier in the study. If you recognize an image, press 'Yes', if you do not recognize an image, \
      press 'No'.</p>" +
