    ...
    for (var ii = 0; ii < num_trial; ii++) {
        ...
        */
        ...
        var bubble_phase = {
            ...
            prompt: '<p class = block-text>Please inspect the image.</p>',
        ...
        var rating_bubble_phase = {
            type: 'html-button-response',
            stimulus: '<p class = block-text>' +
                'Please rate how much you liked the picture (1:none - 7:extremely).</p>',
            choices: ['1', '2', '3', '4', '5', '6', '7'],
            data: {
    ...
    for (var ii = 0; ii < num_trial; ii++) {
        ...
        */
        ...
        var bubble_phase = {
            ...
            prompt: null, //'<p class = block-text>Please inspect the image using up to <b>' + maximum_click + '</font></b> bubbles.</p>',
            trial_type: 'fixed_viewing_duration', // or 'fixed_click_maximum'
            viewing_duration: 12000,
            //maximum_click: maximum_click,
            bubble_size: 70,
