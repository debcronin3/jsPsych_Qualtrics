...
function generate_test_block(test_img_src, test_seq, img_ext) {
  ...
  var test_instructions_page = {
    type: "instructions",
    pages: [
      "<div class = centerbox><p class = block-text> You finished viewing the images! Now we will test your memory.</p>" +
  ...
  for (var ii = 0; ii < num_trial; ii++) {
    var memory_phase = {
      ...
      choices: [37, 39],
      prompt:
        "<p class = block-text>Press RIGHT ARROW if you remember the image, LEFT ARROW if you do not.</p>",
      data: {
